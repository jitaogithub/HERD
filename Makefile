...
yama_starter: yama_starter.o common.o conn.o
	${LD} ${CFLAGS} -o $@ yama_starter.o common.o conn.o yama/comm_rcm.o yama/comm.o yama/flow.o yama/logging.o yama/pacer.o ${LDFLAGS}
